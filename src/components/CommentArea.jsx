    ...
    return (
        <>
            <div className="w-full px-5">
                <div><h2 className='mb-4 inline-block '>Comments</h2> <button className='inline-block ml-4 text-blue-500 text-base' onClick={getDataFromApi}>Load comments</button></div>
