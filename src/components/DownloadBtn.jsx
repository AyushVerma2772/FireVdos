...
const DownloadBtn = ({ videoId }) => {
    ...
    return (
        <>
            <select onChange={(e) => handleDownload(e)} className='cursor-pointer p-2 px-3 bg-stone-200 hover:bg-stone-300/80 dark:bg-[#272727] dark:hover:bg-zinc-700/70 outline-none rounded'
            >
